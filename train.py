...
# Huggingface datasets and tokenizers libraries
...
def run_validation(model, validation_ds, tokenizer_src, tokenizer_tgt, max_len, device, print_msg, global_step, writer,
    ...
    with torch.no_grad():
        for batch in validation_ds:
            ...
            # we print_msg instead of print to allow because we use the tdqm progress bar
...
def train_model(config):
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        # keep the state of optimizer with the weights
        torch.save({
            'epoch': epoch,
